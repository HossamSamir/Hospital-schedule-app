        ...
        <FlatList
          ...
          renderItem = {({ item }) => (
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', marginRight: 20 }}>
              <Image style={{ flex: .2 }} source={require('../assets/img/new/h_icon.png')} style={{ width: 50, height: 50, marginHorizontal: 10, borderWidth: 2, borderColor: '#1e537d', borderRadius: 10}} />
              <TouchableHighlight
                 onPress={ () => {
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%', }}>
            <View style={{ flex: .8, backgroundColor: 'transparent' }}>
              <Image source={require('../assets/img/new/1.png')} style={{ width: 250, height: 210, resizeMode: 'stretch' }} />
            </View>
