...
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      size: { width, height },
      HospitalNames: ['Hospital #1', 'Hospital #2', 'Hospital #3', 'Hospital #4', 'Hospital #5', 'Hospital #6', 'Hospital #7']
    };
  }
  ...
  _Hopitals = (rownum) => {
    return (
      this.state.HospitalNames.forEach((hospital) => (
        <View>
          <TouchableHighlight style={{ backgroundColor: '#11284b', margin: 10, padding: 10, borderRadius: 10, height: 40, alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{ color: 'white', fontWeight: 'bold', }}>hospital</Text>
          </TouchableHighlight>
          <TouchableHighlight style={{ backgroundColor: '#11284b', margin: 10, padding: 10, borderRadius: 10, height: 40, alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{ color: 'white', fontWeight: 'bold', }}>hospital</Text>
          </TouchableHighlight>
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', width: '100%', }}>
            ...
            <View style={{ flex: 1, backgroundColor: 'transparent', marginTop: 30, justifyContent: 'center', alignItems: 'center' }}>
              <Text style={{ fontSize: 23, color: '#11284b', fontWeight: 'bold' }}>Choose A Hospital</Text>
